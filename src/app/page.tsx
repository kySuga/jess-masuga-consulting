  ...
  return (
    <>
      <div className={styles.hero}>
        <div className={`gutter-alley__wrap ${styles.hero__content}`}>
          <div className="top-to-bottom__wrap">
            ...
            <p>
              ...
              including biotech, medtech, medical device, pharma, and
              nonprofits. I’m ready to support any size program in partnership
      ...
      <div className="top-to-bottom__wrap banner">
        <div className={`gutter-alley__wrap ${styles.content__contact}`}>
          <h2>Contact Me</h2>
          <p>
      ...
      <div className="gutter-alley__wrap">
        <div className={`top-to-bottom__wrap ${styles.campaign}`}>
